...
def train_model(arg_parser, shadow: bool = False, id: Optional[str] = None):
    ...
    # TODO: in most cases the train transformations are different from the evaluation transformations
    ...
    if args.wandb:
        ...
        wandb_logger = WandbLogger(
            name=f'{arch_name} {args.dataset}', project=None, entity=None, log_model=not args.do_not_save_model
        )
...
def get_model_training_arg_parser() -> argparse.ArgumentParser:
    ...
    # dataset arguments
    parser.add_argument('--dataset', default='CIFAR10', help='The dataset to use for training')
    parser.add_argument(
        '--num_classes',
        default=None,
    ...
    # model name
    parser.add_argument('--arch', type=str, default="CifarResNet18")
